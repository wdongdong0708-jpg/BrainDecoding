...
from .evaluate import 验证检查点合同
from braindecoding.data import chineseeeg2 as data
...
def main(dataset_name="ChineseEEG2", record_audit=False):
    ...
    if dataset_name in CHINESEEEG2_AUDIT_CONFIGS:
        ...
        if dataset_name == "LibriBrain100":
            from braindecoding.tasks.word_decoding.libribrain100 import train as task_training
